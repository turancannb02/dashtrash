...
│  💾 Disk   █░░░░░░░░░░░░░░░░░░░      ▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁    30.3 GB free                                   │
│           5.1%                                                                                           │
│  🌐 Net    ↑ 8.1 kB/s ↓ 26.1 kB/s  🔴 ██████████       Total: 2.7 GB                                  │
╰──────────────────────────────────────────────────────────────────────────────────────────────────────────╯

╭────────────── 🌡️ Temperature Monitor ──────────────╮  ╭─────────────────── ⏰ Current Time ────────────────────╮
│ Sensor      Temp    Status   Chart         Limits  │  │  __ _  _  _      ___   ___                               │
│ Cpu Core 0  68.0°C  ✅ OK    ▁▂▃▄▅▆▇█▁▂▃▄  80°/90° │  │ /_ | || || |_   / _ \ / _ \                              │
│ Cpu Core 1  60.0°C  ✅ OK    ▁▁▂▃▄▅▆▇█▁▂▃  80°/90° │  │  | | || || __|  \_, | \_, |                              │
│ System      53.0°C  ✅ OK    ▁▁▁▂▃▄▅▆▇█▁▂  75°/85° │  │  |_|\__/ |_|      /_/   /_/                              │
│                                                     │  │                                                         │
│              🌡️ Avg: 48.7°C | Refresh: 3s          │  │                        ⭐ 14:29:04                        │
╰─────────────────────────────────────────────────────╯  │                                                         │
...
*Three-panel layout showing system metrics, temperature monitoring, and real-time clock with personality*

### Features Showcase

✨ **System Monitoring**: Real-time CPU, RAM, disk, and network with ASCII charts  
🌡️ **Temperature Control**: Monitor CPU and system temperatures with visual alerts  
⏰ **Smart Clock**: ASCII time display with fun day indicators and system uptime  
🎨 **Beautiful ASCII Art**: "DashTrash" banner with author credit  
📊 **Multi-Panel Layout**: Flexible positioning (top, left, right) with independent refresh rates  
...
- **`temperature`** - CPU/system temperature monitoring with alerts
- **`clock`** - Real-time clock with ASCII art and day vibes
...
- 🔥 **Dynamic Icons** - CPU changes from 💻 → ⚡ → 🔥 based on load
- 🌡️ **Temperature States** - ❄️ COOL → 🔶 WARM → ⚠️ HOT → 🔥 CRITICAL
- 🚀 **Network Activity** - 🌐 → 📡 → 🚀 based on throughput
- 🎉 **Day Personalities** - From 😴 Monday Blues to 🎉 FRIDAY!

**Enhanced Layouts:**
- 📊 **Multi-panel Support** - top, left, right, bottom positioning
- 🎯 **Smart Positioning** - Adapts to terminal size
- 🔄 **Independent Refresh** - Each panel updates at its own rate
- 🌈 **Color Coding** - Green/Yellow/Red status throughout
